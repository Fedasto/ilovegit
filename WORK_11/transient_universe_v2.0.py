...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 20 20:19:18 2023
...
def LogLikelihood(b,A,t0,alpha, data, model=burst_model):
...
def LogPosterior(theta,data,model=burst_model):
    return LogLikelihood(b,A,t0,alpha, data, model=burst_model) + LogPrior(b,A,t0,alpha)
